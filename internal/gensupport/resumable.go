...
import (
	...
	"github.com/FPNL/google-bm-api-golang/internal"
)
...
func (rx *ResumableUpload) doUploadRequest(ctx context.Context, data io.Reader, off, size int64,
	final bool) (*http.Response, error) {
